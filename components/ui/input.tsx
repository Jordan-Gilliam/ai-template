  ...
  ({ className, children, ...props }, ref) => {
    return (
      <div className="mt-2 flex w-full rounded-md ">
        <div
          className={cn(
            " relative w-full before:pointer-events-none before:absolute before:-inset-1 before:rounded-[9991px] before:border before:border-teal-500/20 before:opacity-0 before:transition dark:before:border-teal-400/80 dark:before:ring-2 dark:before:ring-indigo-900/40",
            ...
            "focus-within:before:opacity-100 focus-within:after:shadow-teal-500/100 dark:after:shadow-white/5 dark:focus-within:after:shadow-teal-500/30"
          )}
        >
          <input
            type="search"
