...
function Switch({
  ...
  return (
    ...
    >
      <span className="mr-4 h-6 w-9 cursor-pointer rounded-full border-2 border-transparent bg-zinc-600 ring-offset-2 ring-offset-zinc-900 transition duration-200 group-data-[selected]:bg-teal-400 group-data-[focus-visible]:ring-2">
